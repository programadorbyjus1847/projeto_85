...
ctx.drawImage(greencar_imgTag, greencar_x, greencar_y, greencar_width, greencar.height);
...
{
	{
	   ...
	   {
		   greencar_y = greencar_y + 10;
		   console.log("When dowm arrow is pressed, x = " = greencar_x + " / y = " +greencar_y);
		   uploadBackground();
		   uploadgreencar();
	   }
}
